...
public class AssetLord {
	...
	public static String menu_back_tex;
...
//	public static final String menu_back_tex = "final/gradient-abstract-hd.jpg";
	...
	public static final String menu_atlas = "final/menu.pack";
	public static final String menu_skin = "final/uiskin.json";
	public static final String game_atlas = "final/game.pack";
...
//		manager.load(wall_tex, Texture.class);
//		manager.load(tutorial1_tex, Texture.class);
//		manager.load(tutorial2_tex, Texture.class);
//		manager.load(tutorial3_tex, Texture.class);
//		manager.load(tutorial4_tex, Texture.class);
		manager.load(pause_back_tex, Texture.class);
		//manager.load(bullet_tex, Texture.class);
		//manager.load(bullet_power_tex, Texture.class);

		//manager.load(button_left_tex, Texture.class);
		//manager.load(button_right_tex, Texture.class);
		//manager.load(button_up_tex, Texture.class);
		//manager.load(button_fire_tex, Texture.class);
		...
		manager.load(portal_particle, ParticleEffect.class, pep);
		manager.load(gravity_rev_particle, ParticleEffect.class, pep);
		manager.load(beamspot_particle, ParticleEffect.class, pep);
		
		//TODO:make them fetch from different atlas
		manager.load(square_floor_particle, ParticleEffect.class, pep);
		manager.load(intro_somke_particle, ParticleEffect.class, pep);
...
//		manager.load(right_spark_particle, ParticleEffect.class, pepG);
//		manager.load(meteor_particle, ParticleEffect.class, pepG);
//		manager.load(powerup_particle, ParticleEffect.class, pepG);
//		manager.load(player_explode_particle, ParticleEffect.class, pepG);
	...
	public void finishLoading(){
		...
		manager.get(game_music, Music.class).setVolume(0.2f);
		manager.get(game_music, Music.class).setLooping(true);
		...
		if(resized) return;
		manager.get(player_jump_particle, ParticleEffect.class).scaleEffect(MyGame.PTP);
		manager.get(enemy_kill_particle, ParticleEffect.class).scaleEffect(MyGame.PTP);
		manager.get(portal_particle, ParticleEffect.class).scaleEffect(MyGame.PTP * 0.75f);
...
//		manager.get(player_explode_particle, ParticleEffect.class).scaleEffect(1 * MyGame.PTP * 2);
