...
public class SplashScreen implements Screen{
	...
	public SplashScreen(MyGame g, AssetLord ass){
		...
		if(GameScreen.DEBUG)Gdx.app.log("Splash Gdx", "W:"+Gdx.graphics.getWidth()+", H:"+Gdx.graphics.getHeight());
	...
	public void show() {
		...
		githubTex.setFilter(TextureFilter.Linear,TextureFilter.Linear);
